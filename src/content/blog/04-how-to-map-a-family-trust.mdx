...
Klaris is built to support this process. Using the KRSP Framework (Know, Record, Structure, Protect), accountants can build and maintain a living wealth structure map for each client group that updates with every review and is accessible to all authorised advisers. [See how Klaris works for accountants](/for-accountants).
