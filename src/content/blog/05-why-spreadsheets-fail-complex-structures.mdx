...
This is exactly what Klaris does. It is built around the KRSP Framework (Know, Record, Structure, Protect) and designed specifically for Australian accounting and advisory firms managing high net worth client groups. [See how Klaris works for accountants](/for-accountants).
